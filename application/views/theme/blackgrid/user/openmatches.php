...
<div style="font-size:15px">@<?=$host->username?></div>
...
Prize : ₹ <?=$reward?>
 ...
 <a href="<?=base_url('user/joinmatch/'.$match->id)?>" class="btn btn-sm btn-success w-100 mt-1 showloading"><i class="bi bi-play-fill"></i> <b>Play Match ( ₹ <?=$match->amount?>)</b></a>
